...
def run_clustering(psf: sta.FileRef, traj: sta.FileRefList,
                   sel: str, cutoff: float, criterion: str,
                   method: str, write_file: bool,
                   write_file_represent: bool) -> None:
    ...
    for i in range(1, num_clus+1):
        ...
        dmat = dmat[:, clus == i]
        # m = dmat.shape[0]  # uncomment for debugging
...
def main(settings: Optional[dict] = None) -> None:
    ...
    run_clustering(settings['psf'], settings['traj'], sel, cutoff,
                   criterion, method, write_file, write_file_represent)
